...
Sortowane były jedynie oceny filmów. Sortowania odbyły się dla 10 000, 100 000, 500 000 oraz maksymalnej ilości danych z pliku po przefiltrowaniu. Dla każdego zstawu danych wykonano po 100 pomiarów.
...
\begin{table}[H]
    \centering
    \caption{Dokładny i przybliżony czas sortowania przez scalania}
